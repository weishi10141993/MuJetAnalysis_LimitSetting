...
float BKG_norm_2018_SR3 = 1.164, BKG_syst_2018_SR3 = 1.023;

// Systematic Uncertainties: Need to add MC scale to data at high mass, to be updated: PU/mass window/HLT
float lumi_13TeV_2018 = 1.025, mu_hlt_2018  = 1.050, mu_id_2018  = 1.024, mu_iso_2018  = 1.002, mu_pu_2018  = 1.0005, mu_pu_eff_2018 = 1.018, ovlp_trk_2018 = 1.024, ovlp_mu_2018 = 1.026, dimu_M_2018 = 1.0024, nnlo_pt_2018 = 1.02, pdf_as_2018 = 1.08, HxecBr_2018 = 1.038;
