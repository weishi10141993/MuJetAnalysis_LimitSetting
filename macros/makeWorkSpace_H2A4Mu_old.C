...
void makeWorkSpace_H2A4Mu_old(double mA_GeV = 0.4, int seed=37) {
  ...
  RooGenericPdf dia4( "dia4", "generic PDF for diaginal region", "fabs(m1 - m2) < 5.*(0.026 + 0.013*(m1 + m2)/2.)", RooArgSet(m1,m2) );
  RooGenericPdf dia5( "dia5", "generic PDF for diaginal region", "fabs(m1 - m2) < 5.*(0.026 + 0.013*(m1 + m2)/2.)", RooArgSet(m1,m2) );
  RooGenericPdf dia6( "dia6", "generic PDF for diaginal region", "fabs(m1 - m2) < 5.*(0.026 + 0.013*(m1 + m2)/2.)", RooArgSet(m1,m2) );
